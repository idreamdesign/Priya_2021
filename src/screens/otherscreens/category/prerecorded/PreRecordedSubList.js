...
export const PreRecordedSubList = (props) => {
	return (
			...
			<View style={{ marginTop: 10 }}>
				...
				<ScrollView>
					{[ 1, 2, 3, 4, 5, 6, 7, 8 ].map((item, i) => {
						return (
							<TouchableOpacity
								onPress={() => props.navigation.navigate('PreRecordedView')}
...
export default connect(mapStateToProps, mapDispatchToProps)(PreRecordedSubList);
